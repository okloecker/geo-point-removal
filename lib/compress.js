 ...
 * @param {function} options.compressFunction - will be called with arguments prevPoint, currPoint and nextPoint; if this returns "true", the current point will be kept
...
function compress(
  ...
  return track.filter((pt, i, arr) => {
    ...
    // if compressFunction() returns true, the point will be kept
